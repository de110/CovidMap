      ...
      <svg>
        ...
        <g id="text-g" class="text-g">
          <text class="text-wrapper" font-size="10">
            1차 접종
            <tspan x="155" y="195" font-size="15">{{ firstTotal }}%</tspan>
          </text>
...
import { MetropoliApi } from '../api/index';

const MAP_GEOJSON = require("../assets/local/Busan.json");
const population = 3358763;
